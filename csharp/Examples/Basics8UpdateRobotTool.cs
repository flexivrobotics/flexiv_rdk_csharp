...
";
        public void Run(string[] args)
        {
            ...
            try
            {
                ...
                Utility.SpdlogInfo($"Current active tool: [{tool.GetToolName()}]");
