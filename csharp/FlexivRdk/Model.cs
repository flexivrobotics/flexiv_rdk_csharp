...
namespace FlexivRdk
{
    public class Model : IDisposable
    {
        ...
        public double[,] GetJacobian(string linkName)
        {
            FlexivError error = new();
            int rows = 6;
            int cols = 7;
        ...
        public double[,] GetJacobianDot(string linkName)
        {
            FlexivError error = new();
            int rows = 6;
            int cols = 7;
        ...
        public double[,] GetCoriolisCentripetalMatrix()
        {
            FlexivError error = new();
            int dof = 7;
            var buffer = new double[dof * dof];
        ...
        public double[] GetGravityForceVector()
        {
            int dof = 7;
        ...
        public double[] GetCoriolisForceVector()
        {
            int dof = 7;
            var buffer = new double[dof];
        ...
        public (double transScore, double orientScore) ConfigurationScore()
        {
            FlexivError error = new();
