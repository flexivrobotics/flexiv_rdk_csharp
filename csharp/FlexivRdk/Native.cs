...
namespace FlexivRdk
{
    internal static class NativeFlexivRdk
    {
        ...
        [DllImport(k_flexivRdkDll, CallingConvention = CallingConvention.Cdecl)]
        public static extern void DefaultLimits(IntPtr safety, ref SafeLimits limits);

        [DllImport(k_flexivRdkDll, CallingConvention = CallingConvention.Cdecl)]
        public static extern void CurrentLimits(IntPtr safety, ref SafeLimits limits);
